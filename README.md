...
| Bean Rush 公式サイト | https://wasabibeans.github.io/beanrush/ | Bean Rushの紹介ページ |
| Bean Rush プライバシーポリシー | https://wasabibeans.github.io/beanrush/privacy-policy.html | データの扱い |
| Bean Rush 利用規約 | https://wasabibeans.github.io/beanrush/terms-of-use.html | 利用条件 |
| Bean Rush サポートページ | https://wasabibeans.github.io/beanrush/support.html | FAQと不具合報告 |
| FishLog 公式サイト | https://wasabibeans.github.io/fishlog/ | FishLogの紹介ページ |
| FishLog プライバシーポリシー | https://wasabibeans.github.io/fishlog/privacy-policy.html | データの扱い |
| FishLog 利用規約 | https://wasabibeans.github.io/fishlog/terms-of-use.html | 利用条件 |
| FishLog サポートページ | https://wasabibeans.github.io/fishlog/support.html | FAQと不具合報告 |
...
| `beanrush/` | Bean Rushの公式サイト、規約、サポート |
| `fishlog/` | FishLogの公式サイト、規約、サポート |
| `assets/` | サイトで使う画像、動画、アイコン |
| `app-ads.txt` | AdMob用ファイル |

Finderで確認する時は、このフォルダの `index.html` を開きます。
画像や内部リンクが壊れないよう、HTML内のリンクは相対パスで書いています。

## 運用ルール

- SNSプロフィールには `WasabiBeans SNSリンク集` だけを貼ります。
- アプリごとの公式ページは、必ず `healthymeal/` や `memeclash/`、`beanrush/`、`fishlog/` のようなアプリ別フォルダに置きます。
